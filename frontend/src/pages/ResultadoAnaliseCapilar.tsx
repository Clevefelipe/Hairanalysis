  ...
  return (
    <div className="space-y-8 p-6 animate-page-in">
      <div className="text-center">
        ...
        <p className="text-slate-600">Resumo técnico assistido pela IA para suporte profissional</p>
      </div>
      ...
      <Card title="Aviso importante" variant="attention">
        <p className="text-sm text-slate-600">
          Conteúdo gerado para apoio técnico-estético. A decisão final é sempre do profissional responsável.
        </p>
      </Card>
